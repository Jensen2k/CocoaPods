Pod::Spec.new do |s|
  s.name         = "THSpringyCollectionView"
  s.version      = "0.0.1"
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/rFlex/THSpringyCollectionView"
  s.license      = {
    :type => 'MIT',
    :file => 'LICENSE'
  }
  ...
  s.source       = {
    :git => 'https://github.com/Jensen2k/THSpringyCollectionView.git',
    :commit => '0832f78f9f',
    :submodules => true
  }
  s.platform     = :ios
  ...
  s.source_files = 'THSpringyCollectionView/**/*.{h,m}'
end